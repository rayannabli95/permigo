...
export function mountHeroKeyScrub(rootEl, opts = {}) {
  ...
  host.innerHTML = `
    <style>
      ...
      /* object-position center 35% : montre PLUS le haut (réduit le crop top sur la dernière frame) */
      .hks-video{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center 35%;will-change:contents;background:#000}
  ...
  if (reduceMotion) {
    ...
    video.play().catch(() => {});
    // Cache l'indicateur "SCROLL" pour ne pas mentir

export const TRANSMISSIONS = {
  manual: {
    ...
    short: "Manuelle",
    symbol: "H",
    description: "Embrayage, rapports et point de patinage intégrés aux missions.",
  },
  automatic: {
    id: "automatic",
    ...
    short: "Automatique",
    symbol: "D",
    description: "Sélecteur P/R/N/D et conduite au pied droit intégrés aux missions.",
  },
};
...
export const WORLDS = [
  {
    id: 1,
    code: "C1",
    eyebrow: "Prends le contrôle",
    title: "Le cockpit",
    description: "Tes mains et tes pieds trouvent les commandes sans quitter la route.",
    color: "#8b6dff",
    dark: "#4e2cc7",
    icon: "wheel",
  },
  {
    id: 2,
    code: "C2",
    eyebrow: "Lis la route",
    title: "La ville vivante",
    description: "Tu repères les indices et choisis avant que la situation se ferme.",
    color: "#41c7d8",
    dark: "#087d96",
    icon: "city",
  },
  {
    ...
    description: "Nuit, pluie et urgence : tu adaptes tes gestes sans précipitation.",
    color: "#ff8a5b",
    dark: "#b43d2b",
    icon: "storm",
  },
  {
    id: 4,
    code: "C4",
    eyebrow: "Conduis en autonomie",
    title: "La route ouverte",
    description: "Tu décides seul, suis ton itinéraire et anticipes loin.",
    color: "#f4c75e",
    dark: "#a86810",
    icon: "route",
  },
...
export const MISSIONS = [
  {
    ...
    prompt: "Tu vas tourner à gauche. Touche la commande que ta main doit trouver.",
    visual: "cockpit",
    xp: 120,
    hotspots: [
    ...
    retry: "Cette zone ne commande pas le clignotant. Regarde de l’autre côté du volant.",
    success: "Commodo gauche trouvé.",
    why: "Ce repère doit devenir automatique pour garder les yeux sur la route.",
    transfer: "En voiture à l’arrêt, actionne trois fois le clignotant sans baisser les yeux.",
  },
  {
    ...shared,
    ...
    retry: "Pas encore. Repars du moment où la voiture est immobile et sécurisée.",
    ...
    transfer: "Pendant la prochaine leçon, annonce mentalement les cinq gestes avant de démarrer.",
  },
  {
    ...shared,
    ...
    retry: "Pas encore. Commence par immobiliser la voiture avec ton pied droit.",
    success: "Chaîne de départ reconstruite.",
    why: "En D, la voiture avance au ralenti dès que tu relâches le frein : ton pied droit contrôle le départ.",
    transfer: "En voiture à l’arrêt, montre au moniteur la chaîne complète avant de partir.",
  },
  {
    ...shared,
    id: "c1a-temoin",
    ...
    visual: "warning",
    symptom: "Un témoin rouge reste visible après le contrôle du tableau de bord.",
    xp: 140,
    choices: [
    ...
    transfer: "Au prochain démarrage, observe le tableau jusqu’à l’extinction des témoins.",
  },
  {
    ...shared,
    id: "c2f-indices",
    ...
    xp: 130,
    hotspots: [
      { id: "side-street", label: "Ouverture entre les bâtiments", x: 66, y: 35, w: 25, h: 42 },
    ...
    retry: "Ce détail ne révèle pas l’intersection. Cherche l’endroit où une rue peut déboucher.",
    ...
    transfer: "Pendant la prochaine leçon, annonce chaque intersection avant d’y arriver.",
  },
  {
    ...shared,
    id: "c2f-giratoire",
    ...
    objective: "Préparer une sortie de giratoire sans couper la trajectoire d’un autre usager.",
    prompt: "Ta sortie approche. Quelle action vient en premier ?",
    visual: "roundabout",
    xp: 140,
    choices: [
      { id: "accelerate", label: "Accélérer immédiatement vers la sortie" },
      { id: "check-signal", label: "Contrôler, puis mettre le clignotant droit" },
  ...
  },
  {
    ...
    prompt: "Trois trajectoires apparaissent. Choisis celle qui garde sa voie sans couper.",
    visual: "bend",
    xp: 150,
    paths: [
      { id: "cut", label: "Couper vers la ligne centrale", className: "path-cut" },
      { id: "safe", label: "Suivre sa voie et regarder la sortie", className: "path-safe" },
    ...
    retry: "Cette ligne mord un bord de ta voie. Cherche la trajectoire la plus stable.",
    ...
    transfer: "Au prochain virage, cherche la sortie avec les yeux avant de tourner le volant.",
  },
  {
    ...shared,
    id: "c3a-nuit",
    ...
    objective: "Poser son regard au bon endroit lorsqu’un véhicule arrive de nuit.",
    prompt: "Les phares arrivent en face. Touche la zone que ton regard doit suivre.",
    visual: "night",
    xp: 140,
    hotspots: [
      { id: "headlights", label: "Phares en face", x: 43, y: 28, w: 19, h: 22 },
      { id: "right-edge", label: "Bord droit de ta voie", x: 64, y: 58, w: 27, h: 35 },
    ...
    transfer: "En conduite de nuit, verbalise ton repère droit dès qu’un véhicule approche.",
  },
  {
    ...shared,
    id: "c3b-pluie",
    ...
    objective: "Adapter la distance et la douceur avant que l’adhérence diminue.",
    prompt: "La pluie devient forte. Quelle adaptation protège le mieux ta marge ?",
    visual: "rain",
    xp: 140,
    choices: [
    ...
    transfer: "À la première pluie, compte quatre secondes avec le véhicule devant.",
  },
  {
    ...shared,
    ...
    retry: "Pas dans cet ordre. Commence par l’action qui réduit immédiatement la vitesse.",
    ...
    transfer: "Demande à ton enseignant quand vous entraînerez ce geste sur une zone adaptée.",
  },
  {
    ...shared,
  ...
  },
  {
    ...
    objective: "Réagir en autonomie lorsqu’une instruction GPS arrive trop tard.",
    prompt: "Ta sortie vient de passer. Quelle décision répare la situation sans créer de danger ?",
    visual: "gps",
    symptom: "Le GPS annonce « Tournez maintenant », mais la bretelle est déjà derrière toi.",
    xp: 150,
    choices: [
    ...
    retry: "Cette action crée un danger immédiat pour récupérer une simple direction.",
  ...
  },
  {
    ...
    transfer: "Pendant la prochaine leçon, repère un ralentissement assez tôt pour lever le pied avant de freiner.",
  },
  {
    ...shared,
    id: "c4f-verification",
    ...
    prompt: "Un défaut est visible avant de partir. Touche celui que tu dois signaler.",
    visual: "exterior",
    xp: 130,
    hotspots: [
      { id: "flat-tire", label: "Pneu avant affaissé", x: 58, y: 65, w: 20, h: 22 },
    ...
    transfer: "Avant la prochaine leçon, fais le tour de la voiture et nomme tes quatre contrôles.",
  },
];

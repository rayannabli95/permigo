...
export function ensureHeatmapStyles() {
  ...
  style.textContent = `
    ...
    .hmap-tooltip{position:fixed;background:var(--ink);color:var(--su);font:600 11px/1.4 'Archivo',sans-serif;padding:6px 10px;border-radius:8px;pointer-events:none;z-index:9000;opacity:0;transition:opacity .15s;white-space:nowrap;box-shadow:0 4px 12px rgba(0,0,0,.2)}
  `;

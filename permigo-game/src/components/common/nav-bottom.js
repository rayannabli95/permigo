...
const TABS = {
  ...
  eleve: [
    ...
    },
    {
      ...
      // « mon-permis » et la page « examen » qui l'accompagnaient sont
      // supprimés (02/08/2026) ; il ne reste que le centre d'examen à
      // rattacher à cet onglet.
      id: "parcours",
      label: "Mon permis",
      ico: "map",
      match: ["centre-examen"],
...
export function mountBottomNav(role) {
  ...
  // Reconstruire à chaque fois détruirait le limelight → plus de glissé entre
  // onglets. Si la nav du même rôle est déjà là, on rafraîchit juste l'onglet actif (le

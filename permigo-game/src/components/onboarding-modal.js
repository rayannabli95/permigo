...
const SLIDES = [
  ...
  },
  {
    illo: `<div style="display:flex;flex-direction:column;align-items:center;gap:6px">
      ...
      <div style="font:800 36px/1 'Plus Jakarta Sans',sans-serif;background:linear-gradient(135deg,#6366f1,#8b5cf6);-webkit-background-clip:text;background-clip:text;color:transparent;letter-spacing:-.04em">12 jours</div>
      <div style="font:500 13px/1 'Inter',sans-serif;color:#64748b">de série continue</div>
    </div>`,

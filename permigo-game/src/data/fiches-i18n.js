...
const FICHE_UI = {
  en: {
    sub: "Tick your steps, then certify the skill.",
    deck: "Your deck",
    geste: "step",
    gestes: "steps",
    ...
    cta_warn:
      "Do it in a lesson with your instructor first. You certify what you can do, not what you just read.",
    order: "Put them in order",
    coach: "Coach cards",
    coach_hook: "Two minutes here save you a whole extra lesson",
    cd_prev: "Previous card",
    cd_next: "Next card",
    cd_tip: "Swipe to see the next one",
    methode: "The method",
    next: "your turn",
    back: "Back",
    err_h: "The mistake to avoid",
    why_h: "Why it matters",
    ctx_h: "When it happens",
    rsk_h: "What you risk",
  ...
  ar: {
    ...
    coach_hook: "دقيقتان هنا توفّران عليك درسًا كاملًا",
    cd_prev: "البطاقة السابقة",
    cd_next: "البطاقة التالية",
    cd_tip: "اسحب للانتقال إلى التالية",
    methode: "الطريقة",
    next: "دورك",
    back: "رجوع",
...
const FICHE_I18N = {
  C1a: {
    en: {
      ...
      competence: "Handling",
      pourquoi:
        "You need to be able to work a turn signal or a windshield wiper without taking your eyes off the road. If you go looking for a control while driving, you stop looking ahead.",
      erreur:
        "Mixing up the two stalks and switching on the wipers instead of the turn signal. Simple reminder: turn signals on the left, wipers on the right.",
      ...
      quiz: [
        {
          ...
          explication:
            "A pro's reminder: turn signals on the left, wipers on the right. You will never get it wrong again.",
        },
        {
          q: "You want to wipe the windshield. What do you use?",
          options: ["The right stalk", "The left stalk", "The headlight flash"],
          explication:
            "Right = windshield wipers and washer. The left one is for your turn signals.",
        },
        {
          ...
          explication:
            "A warning light that stays lit (oil, brake, battery) indicates a real fault.",
        },
        {
          ...
          explication:
            "Nothing under the wheels, tires, lights and plates clean: ten seconds that save you.",
        },
      ],
    },
    ar: {
      ...
      competence: "التحكّم",
      pourquoi:
        "يجب أن تكون قادراً على تشغيل الغمّاز أو ماسحة الزجاج دون أن ترفع عينيك عن الطريق. إذا بحثت عن أحد المفاتيح أثناء القيادة، فإنك تتوقف عن النظر إلى الأمام.",
      erreur:
        "الخلط بين العتلتين وتشغيل ماسحات الزجاج بدلاً من الغمّاز. تذكير بسيط: الغمّاز على اليسار، والماسحات على اليمين.",
      ...
      quiz: [
        {
          ...
          options: ["التي على اليمين", "التي على اليسار", "الزرّ في الوسط"],
          explication:
            "تذكير المحترفين: الغمّاز على اليسار، والماسحات على اليمين. لن تخطئ بعد الآن.",
        },
        {
          q: "تريد مسح الزجاج الأمامي. ماذا تُشغّل؟",
          options: ["العتلة اليمنى", "العتلة اليسرى", "ومضة الأضواء"],
          explication:
            "اليمين = ماسحات الزجاج وغسّالة الزجاج. أما اليسار فهو للغمّازات.",
        },
        {
          q: "مفتاح التشغيل مُدار، وبقي ضوء تحذيري مُضاءً بعد الاختبار. ماذا تفعل؟",
          options: ["تنتظر وتُبلِغ عنه", "تنطلق، سيزول الأمر", "تُطفئ الأضواء"],
          explication:
            "الضوء التحذيري الذي يبقى مُضاءً (الزيت، الفرامل، البطارية) يشير إلى عطل حقيقي.",
        },
        {
          q: "قبل الركوب، ما هو أول ردّ فعل لديك؟",
          options: ["تشغيل المحرّك", "ضبط المذياع", "جولة سريعة حول السيارة"],
          explication:
  ...
  C1b: {
    en: {
      ...
      competence: "Handling",
      pourquoi:
        "A badly adjusted seat = you can't press the clutch all the way down (risk of stalling) and you tire quickly. Thirty seconds of adjusting = a whole lesson that's more comfortable and safer.",
      erreur:
      ...
      quiz: [
        {
          ...
          explication:
            "A straight leg = the clutch isn't pressed all the way down, and you stall without understanding.",
        },
        {
          ...
          explication:
            "It should show the whole rear window without you moving from your place.",
        },
        {
          ...
          explication:
            "Over the shoulder and over the hips, lying flat, never twisted. Otherwise it protects you poorly.",
        },
        {
          ...
          explication:
            "If you can see the road below the lowered sun visor, your eye height is right.",
        },
      ],
    },
    ar: {
      ...
      competence: "التحكم",
      pourquoi:
        "مقعد سيّئ الضبط = لا تستطيع الضغط على دواسة القابض (الكلتش) حتى النهاية (خطر توقّف المحرّك) وتتعب بسرعة. ثلاثون ثانية من الضبط = حصّة كاملة أكثر راحة وأماناً.",
      erreur:
      ...
      quiz: [
        {
          ...
          explication:
            "الساق الممدودة = القابض غير مضغوط حتى النهاية، فيتوقّف المحرّك دون أن تفهم.",
        },
        {
          ...
          explication:
            "يجب أن تُظهر الزجاج الخلفي كاملاً دون أن تتحرّك من مكانك.",
        },
        {
          ...
          explication:
            "على الكتف وعلى الحوض، مستوياً، وغير ملتوٍ أبداً. وإلا فإنه يحمي بشكل سيّئ.",
        },
        {
          ...
          explication:
            "إذا رأيت الطريق تحت واقية الشمس المنزَّلة، فإن ارتفاع نظرك سليم.",
        },
      ],
    },
  },
    ...
    en: {
      ...
      quiz: [
        ...
        },
        {
          ...
          explication:
            "A wheel turns about one and a half turns each way. You do the reverse.",
        },
        {
          ...
          explication:
            "Same logic going forward and in reverse: it keeps you from mixing up right and left.",
        },
        {
          ...
          explication:
            "Repeated wheel jerks get you lost. Slow down first, correct afterward.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "الإبهامان على حافة المقود: تحافظ على الدقّة والقوة للتفاعل بسرعة.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "المنطق نفسه في السير للأمام وللخلف: هذا يمنعك من الخلط بين اليمين واليسار.",
        },
        {
          ...
          explication:
            "الحركات العنيفة المتكرّرة للمقود تُضيّعك. أبطئ أولاً، ثم صحّح بعد ذلك.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "What makes it stall is letting the clutch up all at once at the biting point.",
        },
        {
          ...
          explication:
            "The car weighs a ton: without a little gas when setting off, you stall.",
        },
        {
          q: "You're braking to a complete stop. When do you press the clutch?",
          options: ["Just before stopping", "Right away", "After stopping"],
          explication:
            "Too early = coasting, too late = you stall right before you stop.",
        },
        {
          ...
          explication:
            "With your heel anchored on the floor and sliding, you find the biting point in the same spot every time.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "ما يوقف المحرّك هو إطلاق القابض دفعة واحدة عند نقطة التلامس.",
        },
        {
          q: "لماذا لمسة خفيفة من دواسة الوقود عند الانطلاق؟",
          options: ["لإحداث ضجيج", "لمنح المحرّك قوّة", "ليست مفيدة"],
          explication:
            "السيارة تزن طنًّا: دون قليل من الوقود عند الانطلاق، يتوقّف المحرّك.",
        },
        {
          q: "أنت تفرمل حتى التوقّف التامّ. متى تضغط القابض؟",
          options: ["قبيل التوقّف مباشرة", "فورًا", "بعد التوقّف"],
          explication:
            "مبكّرًا جدًّا = سير حرّ، متأخّرًا جدًّا = يتوقّف المحرّك قبيل التوقّف تمامًا.",
        },
        {
          ...
          explication:
            "مع تثبيت الكعب على الأرض وانزلاقه، تجد نقطة التلامس في المكان نفسه في كلّ مرّة.",
        },
      ],
    },
  },
    ...
    en: {
      ...
      quiz: [
        ...
        },
        {
          ...
          explication:
            "Look far ahead: you see the slow-downs coming and you smooth out your driving.",
        },
        {
          ...
          explication:
            "You aim for an rpm, and if you overshoot you ease off a little without letting go. Even while stopped.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "فرملة المحرك تقوم بجزء من العمل بالفعل. أنت تستبق ولا تفرمل فجأة.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "تستهدف سرعة دوران معينة، وإذا تجاوزتها تُخفّف الضغط قليلاً دون أن ترفع قدمك. حتى والسيارة متوقفة.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "You feel the gears by hand, palm on the knob, without leaving the road.",
        },
        {
          ...
          explication:
            "It's the position of your hand that matters, not the force. A gearbox mistake is an automatic fail.",
        },
        {
          ...
          explication:
            "You downshift because you've already slowed down, to have pulling power on the way out.",
        },
        {
          q: "You stop at a STOP sign. In which gear?",
          options: ["In 1st", "In 2nd", "In neutral"],
          explication:
            "You stop in 2nd, then go back to 1st to set off again. Smoother.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          options: ["إلى العصا", "إلى الطريق، دائماً", "إلى عدّاد السرعة"],
          explication:
            "تشعر بالسرعات بيدك، راحة اليد على المقبض، دون أن تفارق الطريق.",
        },
        {
          ...
          explication:
            "المهم هو وضعية اليد، لا القوة. الخطأ في ناقل الحركة يؤدي إلى الرسوب المباشر.",
        },
        {
          ...
          explication:
            "تخفض السرعة لأنك قد أبطأت فعلاً، لتحصل على قوة سحب عند الخروج.",
        },
        {
          q: "تتوقّف عند إشارة STOP. على أي سرعة؟",
          options: ["على الأولى", "على الثانية", "على الوضع المحايد"],
          explication:
            "تتوقّف على الثانية، ثم تعود إلى الأولى للانطلاق من جديد. أكثر سلاسة.",
        },
      ],
    },
  },
  C1g: {
    en: {
      ...
      pourquoi:
        "A poorly checked car is a moving danger: a bald tyre brakes badly, a dead light means you are not seen. The walk-around is ten seconds that prevent an accident.",
      erreur:
      ...
      quiz: [
        {
          ...
          explication:
            "A bald or damaged tyre brakes badly and can blow out. Look at the wear indicator.",
        },
        {
          ...
          explication:
            "You show, you don't recite: point to the left steering stalk and operate it.",
        },
        {
          ...
          explication:
            "A broken indicator or brake light: others can no longer read your intentions. A direct danger.",
        },
        {
          ...
          explication:
            "You point to the item (the oil cap is here) and make the gesture, calmly.",
        },
      ],
    },
    ar: {
      ...
      competence: "التحكم في السيارة",
      pourquoi:
        "السيارة غير المفحوصة جيدًا خطرٌ متحرك: الإطار الأملس يفرمل بشكل سيئ، والضوء المعطّل يعني أنك غير مرئي. الدوران حول السيارة عشر ثوانٍ تمنع وقوع حادث.",
      erreur:
      ...
      quiz: [
        {
          ...
          explication:
            "الإطار الأملس أو التالف يفرمل بشكل سيئ وقد ينفجر. انظر إلى مؤشّر التآكل.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "غمّازة أو ضوء فرملة معطّل: لم يعد الآخرون يفهمون نيّاتك. خطر مباشر.",
        },
        {
          ...
          explication:
            "تشير إلى العنصر (سدادة الزيت هنا) وتؤدّي الحركة، بهدوء.",
        },
      ],
    },
  },
  C1h: {
    en: {
      titre:
        "Passing the test manoeuvres (parallel parking, U-turn, reverse bay parking)",
      competence: "Vehicle handling",
      pourquoi:
        "The key to a manoeuvre isn't force, it's slowness. The slower you go, the more time you have to turn the wheel and correct. Slow speed + a firm turn of the wheel.",
      erreur:
        "Going too fast and turning the wheel too late. The result: you climb onto the kerb or hit a car. You should do the opposite: slow right down, turn the wheel early and firmly. Another trap: staring at your spot by turning around too soon instead of counting your bays and staying straight, which makes you set off crooked.",
      ...
      quiz: [
        {
          ...
          explication:
            "You are not being timed: going slow gives you time to turn the wheel and correct.",
        },
        {
          ...
          explication:
            "Leaning gently, yes. Mounting or hitting the kerb means an instant fail.",
        },
        {
          ...
          explication:
            "If you aim for the 2nd light, you move too far out. First light = correct path.",
        },
        {
    ...
    ar: {
      titre:
        "النجاح في مناورات الامتحان (الركن الموازي، الدوران بزاوية 180 درجة، الركن للخلف في الخانة)",
      competence: "التحكم في السيارة",
      pourquoi:
        "مفتاح المناورة ليس القوة، بل البطء. كلما سرتَ ببطء أكثر، كان لديك وقت أطول لإدارة المقود والتصحيح. سرعة بطيئة + إدارة حازمة للمقود.",
      erreur:
        "السير بسرعة كبيرة وإدارة المقود متأخرًا جدًا. النتيجة: تصعد على الرصيف أو تصطدم بسيارة. عليك أن تفعل العكس: أبطئ تمامًا، وأدِر المقود مبكرًا وبحزم. فخّ آخر: تثبيت النظر على مكانك بالالتفات للخلف مبكرًا جدًا بدلًا من عدّ الخانات والبقاء مستقيمًا، فتنطلق بشكل مائل.",
      ...
      quiz: [
        {
          ...
          explication:
            "لست مؤقّتًا بزمن: البطء يمنحك الوقت لإدارة المقود والتصحيح.",
        },
        {
          ...
          explication:
            "الاستناد برفق، نعم. أما الصعود على الرصيف أو لمسه فيعني الرسوب فورًا.",
        },
        {
          ...
          explication:
            "إذا استهدفت الضوء الثاني، تبتعد كثيرًا. أول ضوء = المسار الصحيح.",
        },
        {
          ...
          explication:
            "تؤمّن أولًا، وتراقب بزاوية 360 درجة، وتترك الجميع يمرّون.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "Wheel straight, wheels straight, you bring the car toward the side where you have room.",
        },
        {
          ...
          explication:
            "If you wait for the instructor's cue for every move, it isn't mastered yet.",
        },
        {
          ...
          explication:
            "You make it safe before moving, and you never have priority during a maneuver.",
        },
        {
          ...
          explication:
            "On the left on a two-way street, you end up facing oncoming traffic. Choose the right side.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "المقود مستقيم، العجلات مستقيمة، تعيد السيارة نحو الجهة التي لديك فيها مساحة.",
        },
        {
          ...
          explication:
            "إذا كنت تنتظر إشارة المدرّب عند كل حركة، فهي لم تُتقَن بعد.",
        },
        {
          ...
          explication:
            "نؤمّن قبل التحرك، ولسنا أبدًا أصحاب الأولوية أثناء المناورة.",
        },
        {
          ...
          explication:
            "على اليسار في طريق ذي اتجاهين، تصبح في الاتجاه المعاكس. اختر الجهة الصحيحة.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "Looking far ahead gives you time to anticipate instead of being caught off guard.",
        },
        {
          ...
          explication:
            "Knowing who's behind you gets you ready to brake or change lanes without surprises.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "Turning your head lets you see driveway entrances and side streets opening onto the road.",
        },
      ],
    },
    ar: {
      ...
      competence: "السير",
      pourquoi:
        "أنت تقود بعينيك قبل أن تقود بيديك. يلخّص أحد المدرّبين الأمر جيداً: النظر يمثّل نحو 80٪ من القيادة. إذا كان نظرك في المكان الخطأ، فسيكون مسارك سيّئاً مهما فعلت بيديك. وكلما وجّهت نظرك إلى أماكن مختلفة، أعاد دماغك بناء صورة كاملة ودقيقة للمشهد (المسافات والأشكال والمخاطر).",
      erreur:
        'التحديق في غطاء المحرّك، أو في السيارة التي أمامك مباشرة، أو في نقطة واحدة لوقت طويل. النتيجة: تكتشف كل شيء في اللحظة الأخيرة وتكبح بشكل مفاجئ. حيلة المدرّبين هي القيادة المعلَّقة: تقول بصوت عالٍ ما تراه ("ممرّ مشاة، حافة رصيف، لوحة 50"). هذا يُجبر العين على البحث عن المؤشرات وعلى التوقّع المسبق.',
      bva: "",
      methode: [
      ...
      quiz: [
        {
          ...
          explication:
            "النظر بعيداً يمنحك الوقت للتوقّع بدلاً من مواجهة الأمور فجأة.",
        },
        {
          ...
          explication:
            "معرفة من يسير خلفك يجهّزك للكبح أو تغيير المسار دون مفاجآت.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "إدارة رأسك تجعلك ترى مداخل المرائب والشوارع الجانبية التي تصبّ في الطريق.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "The limit is a maximum, not an obligation: the right speed depends on the real risk.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "On a wet surface, your braking distance rockets: double the margin.",
        },
        {
      ...
      quiz: [
        {
          ...
          explication:
            "الحد المسموح هو حد أقصى وليس إلزاماً: السرعة الصحيحة تتوقف على الخطر الحقيقي.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "على أرض مبللة، تتضخم مسافة الفرملة كثيراً: ضاعِف الهامش.",
        },
        {
          ...
          explication:
            "التسارع في النزول يعني اكتساب سرعة بلا فائدة والفرملة بقوة أكبر لاحقاً.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "A door can open or a pedestrian can step out between two cars.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "Well centered, your car is easy to read and you keep margin on both sides.",
        },
        {
          ...
          explication:
            "You move toward the left when it's safe, you never graze the bike.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        ...
        },
        {
          ...
          explication:
            "عندما تكون في المنتصف تمامًا، يسهل فهم مسار سيارتك وتحتفظ بهامش من الجانبين.",
        },
        {
          ...
          explication:
            "تنزح نحو اليسار عندما يكون ذلك آمنًا، ولا تلامس الدراجة أبدًا.",
        },
      ],
    },
  },
    ...
    en: {
      ...
      quiz: [
        ...
        },
        {
          ...
          explication:
            "Your eyes pull the line: if you look at the edge, you go toward the edge.",
        },
        {
          ...
          explication:
            "Pulling with one hand keeps the movement smooth; forcing with both hands tenses you up and pushes you off line.",
        },
        {
          ...
          explication:
            "Accelerating too early opens up your line and pushes you toward the outside.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "تفرمل السيارة جيداً في الخط المستقيم؛ أما الفرملة في المنعطف فتُفقدها توازنها.",
        },
        {
          ...
          explication:
            "النظر يقود المسار: إذا نظرت إلى الحافة، اتجهت نحو الحافة.",
        },
        {
          ...
          explication:
            "السحب بيد واحدة يبقي الحركة مرنة؛ أما الشدّ باليدين فيسبّب التوتر ويُبعدك عن مسارك.",
        },
        {
      ...
      quiz: [
        {
          ...
          explication:
            "Doubt alone is enough to cancel the overtake: you only pass when you can see far and clear.",
        },
        {
          ...
          explication:
            "This sequence guarantees that no one is already in the process of overtaking you.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "Pulling back in too soon forces it to brake: you cut it off.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "الشك وحده كافٍ لإلغاء التجاوز: لا تتجاوز إلا عندما ترى بعيداً وخالياً.",
        },
        {
        ...
        },
        {
          ...
          options: ["1,50 م على الأقل", "50 سم تكفي", "تلتصق به لتمر بسرعة"],
          explication:
            "1,50 م خارج المدينة، متر واحد داخلها: قد ينحرف راكب الدراجة في أي لحظة.",
        },
        {
          ...
          explication:
            "العودة إلى المسار مبكراً جداً تجبرها على الفرملة: فأنت تقطع طريقها.",
        },
      ],
    },
  },
  C2f: {
    en: {
      ...
      competence: "Traffic",
      pourquoi:
        "An intersection is where paths cross: 99% of the work is knowing WHO GOES FIRST before you get there. The right turn signal when leaving a roundabout tells others you are exiting the ring, which frees up those waiting to enter.",
      erreur:
      ...
      quiz: [
        {
          ...
          explication:
            "With no sign, it is priority to the right: you give way to whatever comes from your right.",
        },
        {
          ...
          explication:
            "Roundabout: you give way to those on the ring. Traffic circle: priority to the right, the one entering has priority.",
        },
        {
          ...
          explication:
            "Too early, the signal makes people think you are exiting sooner and blocks others.",
        },
        {
          ...
          explication:
            "If it brakes for you, that is already a failure to give way on your part.",
        },
      ],
    },
    ar: {
      ...
      competence: "السير",
      pourquoi:
        "التقاطع هو المكان الذي تتقاطع فيه المسارات: 99٪ من العمل هو معرفة مَنْ يمرّ أولاً قبل الوصول إليه. إشارة الانعطاف اليمنى عند الخروج من الدوّار تُنبّه الآخرين إلى أنك تغادر الحلقة، وهذا يفسح المجال لمن ينتظرون الدخول.",
      erreur:
      ...
      quiz: [
        {
          ...
          explication:
            "دون أي لوحة، الأولوية لليمين: تُفسح الطريق لما يأتي من يمينك.",
        },
        {
          ...
          explication:
            "الدوّار ذو الأولوية: تُفسح الطريق لمن على الحلقة. الدوّار الصغير: الأولوية لليمين، والداخل له الأولوية.",
        },
        {
          ...
          explication:
            "إن شغّلتها مبكراً جداً، توهم الإشارةُ الآخرين أنك ستخرج قبل ذلك فتعرقلهم.",
        },
        {
          ...
          explication:
            "إن كبحت من أجلك، فهذا يُعدّ أصلاً عدم منح للأولوية من جانبك.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "A turn signal switched on during the turn hasn't warned anyone.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "In town, the use of the horn is in fact strictly limited.",
        },
        {
          ...
          explication:
            "Signalling without moving over keeps the drivers behind you in doubt.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "إشارة الانعطاف التي تُشغّل أثناء الانعطاف لم تُنذر أحدًا.",
        },
        {
      ...
      quiz: [
        {
          ...
          explication:
            "You never force your way into another lane in traffic to make up for a mistake.",
        },
        {
    ...
    ar: {
      ...
      quiz: [
        ...
        },
        {
          ...
          explication:
            "تخيّل المسار يحرّر ذهنك لاتخاذ القرار بدلًا من البحث عن طريقك.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "Staring at the headlights dazzles you; the right edge keeps you on your path.",
        },
        {
          ...
          explication:
            "You lower your beams as soon as you notice someone, even just a glow, so as not to dazzle them.",
        },
        {
          ...
          explication:
            "Certainty = action, doubt = no speed: a dark-clothed pedestrian shows up very late.",
        },
        {
          ...
          explication:
            "Take a break every 2 hours, but above all at the very first sign of tiredness, without waiting.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "تثبيت النظر على الأضواء يُبهرك؛ أما الحافة اليمنى فتُبقيك في مسارك.",
        },
        {
          ...
          explication:
            "نخفّض الأضواء بمجرد أن نلمح شخصًا، ولو مجرد وميض، حتى لا نُبهره.",
        },
        {
          ...
          explication:
            "اليقين = تصرّف، الشك = لا سرعة: المشاة داكن اللباس يظهر متأخرًا جدًا.",
        },
        {
          ...
          explication:
            "خذ استراحة كل ساعتين، لكن قبل كل شيء عند أول علامة تعب، دون انتظار.",
        },
      ],
    },
  },
  C3b: {
    en: {
      ...
      competence: "Difficult conditions",
      pourquoi:
        "Water, snow and ice reduce your tyres' grip: the car slides and takes longer to stop. More distance and more gentleness make up for that lack of grip. And visibility is the other half of the problem: wipers and demisting first, otherwise you're driving \"blind\".",
      erreur:
      ...
      quiz: [
        {
          ...
          options: ["By 2", "You keep the same", "By 1.5"],
          explication:
            "Wet ground = doubled braking: you go from a 2-second to a 4-second gap.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "Charging in = aquaplaning: slow down before, never in the puddle, without turning the wheel.",
        },
        {
          q: "On a motorway limited to 130, it starts to rain. Your max speed?",
          options: ["130 km/h", "110 km/h", "120 km/h"],
          explication:
            "In the rain the 130 drops to 110: less grip, so ease off the accelerator.",
        },
      ],
    },
    ar: {
      ...
      competence: "الظروف الصعبة",
      pourquoi:
        'الماء والثلج والجليد يقللون من تشبث إطاراتك بالطريق: تنزلق السيارة وتحتاج وقتاً أطول للتوقف. زيادة المسافة والقيادة بلطف يعوّضان نقص التشبث هذا. والرؤية هي النصف الآخر من المشكلة: المساحات وإزالة الضباب عن الزجاج أولاً، وإلا فأنت تقود "وأنت أعمى".',
      erreur:
      ...
      quiz: [
        {
          ...
          options: ["×2", "تُبقيها كما هي", "×1.5"],
          explication:
            "أرض مبللة = فرملة مضاعفة: تنتقل من مسافة ثانيتين إلى 4 ثوانٍ.",
        },
        {
          ...
          explication:
            "المصباح الخلفي يُبهر السيارة التي خلفك: فهو مخصص للضباب أو الثلج.",
        },
        {
          ...
          explication:
            "الاندفاع = انزلاق مائي: خفّف السرعة قبلها، لا تفرمل أبداً داخل البركة، ودون أي حركة على المِقود.",
        },
        {
          q: "على طريق سيّار محدود بـ130، بدأ المطر ينزل. ما سرعتك القصوى؟",
          options: ["130 كم/س", "110 كم/س", "120 كم/س"],
          explication:
            "تحت المطر ينخفض الـ130 إلى 110: تشبث أقل بالطريق، فارفع قدمك عن الدواسة.",
        },
      ],
    },
  },
  C3c: {
    en: {
      ...
      competence: "Difficult conditions",
      pourquoi:
        "On a slippery surface, your tyres have very little grip. It is the sudden movement (a jerk of the wheel, a hard brake, a stab of the accelerator) that overwhelms this grip and makes the car slide. Smoothness, on the other hand, preserves your traction.",
      erreur:
        "Braking in the middle of a bend on a slippery surface. Braking and steering at the same time is too much for the tyres: the car keeps going straight or the rear breaks away.",
      bva: "",
      methode: [
      ...
      quiz: [
        {
          ...
          explication:
            "Wet leaves are as slippery as soap: any sudden move makes the car slide away.",
        },
        {
          ...
          explication:
            "Braking and turning together needs too much grip: brake in a straight line, then turn with your foot off the accelerator.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "You anticipate: ease off the accelerator before the slippery zone, never on it.",
        },
      ],
    },
    ar: {
      ...
      competence: "الظروف الصعبة",
      pourquoi:
        "على السطح الزلق، تكون قدرة إطاراتك على التماسك ضعيفة جدًا. إن الحركة المفاجئة (لفّة عنيفة للمقود، كبح قوي، ضغطة حادة على دواسة السرعة) هي التي تتجاوز هذا التماسك وتجعل السيارة تنزلق. أما السلاسة فتحافظ على التصاق الإطارات بالطريق.",
      erreur:
        "الكبح في وسط المنعطف على سطح زلق. الكبح والانعطاف في الوقت نفسه أكثر مما تحتمله الإطارات: تستمر السيارة في السير مستقيمة أو ينزلق مؤخّرها.",
      bva: "",
      methode: [
      ...
      quiz: [
        {
          ...
          explication:
            "الأوراق المبللة تنزلق كالصابون: أي حركة مفاجئة تجعل السيارة تنزلق.",
        },
        {
          ...
          explication:
            "الكبح والانعطاف معًا يتطلبان تماسكًا كبيرًا جدًا: نكبح على خط مستقيم، ثم ننعطف مع رفع القدم عن دواسة السرعة.",
        },
        {
          ...
          explication:
            "تتبع السيارة نظرك؛ أما الكبح الحاد فيزيد الانزلاق سوءًا.",
        },
        {
          ...
          explication:
            "نحن نتوقّع: ارفع القدم عن دواسة السرعة قبل المنطقة الزلقة، لا فوقها أبدًا.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "The brake first, all the way: the clutch comes only afterward, just before stalling.",
        },
        {
          q: "During emergency braking, the pedal vibrates hard under your foot. What do you do?",
          options: ["Let off a little", "Pump the pedal", "Keep pressing hard"],
          explication:
            "The vibration is the ABS working: releasing lengthens the stopping distance.",
        },
        {
          ...
          explication:
            "The car follows your gaze: aiming at the clear space takes you there, staring at the obstacle sends you into it.",
        },
        {
          ...
          explication:
            "ABS prevents locking: you keep steering to avoid the obstacle.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "الفرملة أولاً إلى النهاية: القابض يأتي فقط بعد ذلك، قبل توقف المحرك مباشرة.",
        },
        {
          ...
          explication:
            "الاهتزاز هو نظام ABS وهو يعمل: الرفع يطيل مسافة التوقف.",
        },
        {
          q: "هناك عائق أمامك تماماً أثناء الفرملة الطارئة. إلى أين تنظر؟",
          options: ["إلى العائق", "إلى مخرج النجاة الخالي", "إلى المرايا"],
          explication:
            "السيارة تتبع النظر: استهداف المساحة الخالية يأخذك إليها، وتثبيت النظر على العائق يرسلك نحوه.",
        },
        {
  ...
  C3e: {
    en: {
      ...
      quiz: [
        ...
        },
        {
          ...
          explication:
            "The left lane is for overtaking: clear it as soon as you're past.",
        },
        {
          ...
          explication:
            "You never brake on the motorway: signal early, then slow down on the exit ramp.",
        },
        {
    ...
    ar: {
      ...
      competence: "الظروف الصعبة",
      pourquoi:
        "تعمل الطريق السيارة بتدفق سريع ومنتظم. الهدف هو الاندماج فيه دون كسر هذا التدفق: الوصول إلى السرعة المناسبة للاندماج، والتباطؤ على الجانب (مسار التباطؤ) للخروج، دون مفاجأة أحد. لهذا السبب أيضاً نتحقق من النقطة العمياء جيداً: حتى مع التمركز الجيد، قد يتسلل أحدهم (دراج ناري، أو سيارة تفرض المرور).",
      erreur:
      ...
      quiz: [
        {
          ...
          explication:
            "نندمج في فجوة بسرعتهم؛ الوصول ببطء يجبر الجميع على الفرملة.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "لا تفرمل أبداً على الطريق السيارة: أشر مبكراً، ثم تباطأ على منحدر الخروج.",
        },
        {
          ...
          explication:
            "قد يتسلل دراج ناري أو سيارة إلى النقطة العمياء، غير مرئي في المرآة.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "Dipped headlights make you visible without dazzling anyone; never use full-beam headlights in a tunnel.",
        },
        {
          ...
          explication:
            "In an enclosed space, knowing where to escape makes all the difference if there's a problem.",
        },
        {
          ...
          explication:
            "Side wind pushes the car suddenly: a loose grip on the wheel means swerving.",
        },
        {
          ...
          explication:
            "No U-turns or reversing in a tunnel: switch off the engine and reach the exit on foot.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "الأضواء المنخفضة تجعلك مرئيًا دون أن تُبهر أحدًا؛ لا تستخدم أبدًا الأضواء العالية في النفق.",
        },
        {
          q: "بمجرد وجودك داخل النفق، ما الذي تبحث عنه أولًا؟",
          options: ["أقرب مخرج طوارئ", "محطة الراديو", "سرعة الآخرين"],
          explication:
            "في مكان مغلق، معرفة مكان الهروب تغيّر كل شيء عند حدوث مشكلة.",
        },
        {
          ...
          explication:
            "الرياح الجانبية تدفع السيارة فجأة: المقود المرتخي يعني الانحراف.",
        },
        {
          ...
          explication:
            "ممنوع الالتفاف أو الرجوع للخلف في النفق: تطفئ المحرك وتصل إلى المخرج سيرًا على الأقدام.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "A cyclist coming up on your right is invisible in the mirror: the shoulder glance prevents the accident.",
        },
        {
          ...
          explication:
            "The bus is hiding a pedestrian who could appear: until you're certain, don't accelerate.",
        },
        {
          ...
          explication:
            "1 m in the city (1.5 m outside built-up areas) absorbs the unexpected from a bike that swerves.",
        },
        {
          ...
          explication:
            "A bus leaving its stop has priority: you make room for it.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "راكب دراجة يتقدم على يمينك غير مرئي في المرآة: نظرة الكتف تتجنب الحادث.",
        },
        {
          ...
          explication:
            "الحافلة تخفي مشاة قد يظهرون فجأة: ما دمت غير متأكد، لا تُسرِع.",
        },
        {
          ...
          explication:
            "متر واحد في المدينة (1,50 م خارج المناطق المبنية) يستوعب مفاجأة الدراجة التي تتمايل.",
        },
        {
          ...
          explication:
            "الحافلة التي تغادر موقفها لها الأولوية: نفسح لها المكان.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "Whatever you prepare while stopped frees up your attention for the road.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "Fatigue comes without warning: a regular break is a matter of safety.",
        },
        {
          ...
          explication:
            "A prepared plan B saves you from searching for your exit in a panic.",
        },
      ],
    },
    ar: {
      ...
      competence: "مستقل",
      pourquoi:
        "الرحلة المُخطّطة تعني عقلاً متفرّغاً للطريق. يقول المدرّبون هذا لمن يخافون القيادة بمفردهم: إذا حدّدت علاماتك المرجعية وعرفت أنّ لديك نظام تحديد مواقع احتياطياً وأنّه يمكنك دائماً التوقّف، فستدرك أنّ لديك في الواقع الكثير من الحلول في متناول يدك. لن تبحث عن مخرجك في حالة ذعر في اللحظة الأخيرة.",
      erreur:
        "الانطلاق «حسب الإحساس» وبرمجة نظام تحديد المواقع بعد أن تكون قد بدأت الحركة. ترفع عينيك عن الطريق في أسوأ لحظة، وتكتشف الصعوبات في أثناء السرعة الكاملة.",
      bva: "",
      methode: [
      ...
      quiz: [
        ...
        },
        {
          ...
          explication:
            "ثانيتان بعينين منخفضتين عند سرعة 90 كم/س تعني 50 متراً تُقطع دون رؤية.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "خطة بديلة مُعدّة مسبقاً تجنّبك البحث عن مخرجك في حالة ذعر.",
        },
      ],
    },
  },
  C4b: {
    en: {
      ...
      competence: "Autonomous",
      pourquoi:
        "The GPS is an aid, not a driver. You are the one driving. Your eyes stay outside, on the road and the signs. Reading a sign early gives you time to position yourself without rushing onto your exit.",
      erreur:
        'Missing your exit and trying to "make up for it": braking sharply, reversing, or forcing your way back into a lane. On a motorway or expressway, you NEVER reverse and you never stop for that.',
      bva: "",
      methode: [
      ...
      quiz: [
        ...
        },
        {
          ...
          explication:
            "The lower the name, the closer the exit: move to the right early.",
        },
        {
          ...
          explication:
            "You take the information early (mirrors, indicator) and glide over without losing speed.",
        },
      ],
    },
    ar: {
      ...
      competence: "مستقل",
      pourquoi:
        "نظام تحديد المواقع (GPS) وسيلة مساعدة، وليس سائقًا. أنت من يقود. تبقى عيناك في الخارج، على الطريق وعلى اللافتات. قراءة اللافتة مبكرًا تمنحك الوقت لتضع سيارتك في مكانها دون أن تندفع نحو مخرجك.",
      erreur:
        "أن تفوّت مخرجك وتحاول «تدارك الأمر»: بأن تفرمل فجأة، أو ترجع إلى الوراء، أو تنعطف بقوة لتعود إلى المسار. على الطريق السريع أو المسار السريع، لا ترجع إلى الوراء أبدًا ولا تتوقف من أجل ذلك.",
      bva: "",
      methode: [
      ...
      quiz: [
        {
          ...
          explication:
            "قد يكون نظام تحديد المواقع قديمًا: ما تراه على الطريق يفوز دائمًا.",
        },
        {
          ...
          explication:
            "المخرج الفائت يكلّفك 10 دقائق، لا حياتك: لا رجوع إلى الوراء أبدًا على الطريق السريع.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "تأخذ المعلومة مبكرًا (المرايا، الغمّاز) وتنزلق دون أن تفقد السرعة.",
        },
      ],
    },
  },
  C4c: {
    en: {
      ...
      pourquoi:
        "Smooth driving means up to about 20% fuel saved, a car that wears out less, and passengers who aren't jolted around. Bonus: on the test, eco-driving (shifting gears at the right moment, anticipating, not stalling, controlling the brake) is one of the graded skills.",
      erreur:
        "\"Unanticipated\" braking: you arrive fast at a light or a roundabout, you haven't eased off the accelerator, and you brake hard at the last second. It's bad for fuel use, bad for your passengers, and unsafe for those behind you. Smoothness beats jerkiness.",
      bva: "",
      methode: [
      ...
      quiz: [
        {
          ...
          explication:
            "An engine at low revs uses less fuel, makes less noise and wears out less.",
        },
        {
    ...
    ar: {
      ...
      competence: "مستقل",
      pourquoi:
        "القيادة السلسة تعني توفير ما يصل إلى نحو 20% من الوقود، وسيارة تتآكل أقل، وركابًا لا يتعرّضون للاهتزاز. وميزة إضافية: في الامتحان، تُعدّ القيادة الاقتصادية (تبديل السرعات في الوقت المناسب، والتوقّع، وعدم إطفاء المحرّك، والتحكّم في الفرملة) من المهارات التي تُقيَّم.",
      erreur:
        "الفرملة «غير المتوقّعة»: تصل بسرعة إلى إشارة ضوئية أو دوّار، ولم ترفع قدمك عن دواسة الوقود، فتفرمل بقوة في اللحظة الأخيرة. هذا سيّئ للاستهلاك، وسيّئ لركّابك، وغير آمن لمن خلفك. السلاسة تتفوّق على العصبية.",
      bva: "",
      methode: [
      ...
      quiz: [
        {
          ...
          explication:
            "المحرّك على دورات منخفضة يستهلك أقل، ويُصدر ضجيجًا أقل، ويتآكل أقل.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "السرعة العالية على دورات منخفضة هي ما يستهلك أقل قدر من الوقود.",
        },
      ],
    },
  },
    ...
    en: {
      ...
      quiz: [
        ...
        },
        {
          ...
          explication:
            "Responding to aggression creates the risk; staying composed defuses it.",
        },
        {
          ...
          explication:
            "Hazard awareness means sensing the risk BEFORE you see it.",
        },
        {
          ...
          explication:
            "2 s with the car in front, doubled to 4 s when the road is wet.",
        },
      ],
    },
    ar: {
      ...
      competence: "مستقل",
      pourquoi:
        'السائق الذي يتوقّع نادراً ما يضطر إلى الفرملة الطارئة. النظر بعيداً وباكراً يعني أن لديك وقتاً لاتخاذ القرار بهدوء بدلاً من ردّ الفعل في حالة ذعر. يقول المدرّبون إن الوعي بالخطر "يُحَسّ": وهذا بالضبط ما يريد الفاحص رؤيته، سائق يستشعر الخطر ويعدّل سرعته بدلاً من الاندفاع.',
      erreur:
        'تثبيت النظر على السيارة التي أمامك مباشرة (نظرة قصيرة) والمفاجأة بكل ما يحدث أبعد. أو الاستسلام للغضب والقيادة "للردّ" على سائق آخر.',
      bva: "",
      methode: [
      ...
      quiz: [
        {
          ...
          explication:
            "كلّما رأيت أبعد، كان لديك وقت أكثر لاتخاذ القرار دون ذعر.",
        },
        {
          ...
          explication:
            "الردّ على العدوانية يخلق الخطر؛ البقاء متّزناً ينزع فتيله.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "ثانيتان مع السيارة التي أمامك، تُضاعَف إلى 4 ثوانٍ عندما تكون الطريق مبتلّة.",
        },
      ],
    },
  },
      ...
      quiz: [
        {
          ...
          explication:
            "1 m in town, 1.5 m outside built-up areas: the margin in case they swerve suddenly.",
        },
        {
          ...
          explication:
            "Driving past a pedestrian who wants to cross, on test day, is an automatic fail.",
        },
        {
          ...
          explication:
            "Overtaking tight out of impatience is the most common bicycle accident.",
        },
        {
          ...
          explication:
            "Stopping for someone who does NOT have priority is a fault: you follow your right of way.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "متر واحد داخل المدينة، ومتر ونصف خارج المناطق العمرانية: الهامش في حال انحرف فجأة.",
        },
        {
          ...
          explication:
            "المرور أمام راجل يريد العبور، يوم الامتحان، يعني الرسوب المباشر.",
        },
        {
          ...
          explication:
            "التجاوز الضيّق بدافع نفاد الصبر هو أكثر حوادث الدراجات شيوعاً.",
        },
        {
      ...
      quiz: [
        {
          ...
          explication:
            "It selects 3 free-point questions: vehicle check, road safety, first aid.",
        },
        {
          ...
          explication:
            "A small mistake doesn't make you fail: the examiner looks at your ability to correct yourself.",
        },
        {
          ...
          explication:
            "Each correct answer is worth 1 point: you can fail the test by just 1 point.",
        },
        {
          ...
          explication:
            "You put the indicator on BEFORE stopping for the manoeuvre, not after.",
        },
      ],
    },
    ar: {
      ...
      quiz: [
        {
          ...
          explication:
            "إنه يحدّد 3 أسئلة بنقاط مجانية: فحص، سلامة مرورية، إسعافات أولية.",
        },
        {
          ...
          explication:
            "خطأ صغير لا يُرسبك: ينظر المُفتّش إلى قدرتك على تصحيح نفسك.",
        },
        {
          ...
          explication:
            "كل إجابة صحيحة تساوي نقطة واحدة: يمكن أن ترسب في الامتحان بفارق نقطة واحدة.",
        },
        {
  ...
  C4g: {
    en: {
      ...
      competence: "Autonomous",
      pourquoi:
        'The first years driving alone are the most dangerous: you no longer have the instructor beside you. The "A" disc and the reduced speed limits give you a safety margin while experience builds up. Instructors reassure those who are afraid to drive alone: the licence is a right, not an obligation to head into the city centre on a Friday night the day after you pass. You go at your own pace.',
      erreur:
        'Feeling "free" as soon as you have the licence and dropping the good habits (speed, phone, following distances). A single serious offence can cost you your brand-new licence.',
      bva: "",
      methode: [
      ...
      quiz: [
        {
          ...
          explication:
            "During the probationary period: 110 on the motorway, 100 on expressways, 80 on roads, for the first three years.",
        },
        {
          ...
          explication:
            "It warns others that you're a beginner, so they leave you some room.",
        },
        {
          ...
          explication:
            "6 points at the start: one serious offence can wipe it all out.",
        },
        {
          ...
          explication:
            "0.2 g/l, so in plain terms you don't drink if you're driving.",
        },
      ],
    },
    ar: {
      ...
      competence: "مستقل",
      pourquoi:
        'السنوات الأولى من القيادة بمفردك هي الأخطر: لم يعد المدرّب بجانبك. قرص الحرف "A" وحدود السرعة المخفّضة يمنحانك هامش أمان ريثما تكتسب الخبرة. يطمئن المدرّبون من يخافون القيادة بمفردهم: الرخصة حق وليست إلزاماً بالذهاب إلى وسط المدينة مساء الجمعة في اليوم التالي لنجاحك. تسير وفق وتيرتك الخاصة.',
      erreur:
        "الشعور بأنك «تحرّرت» بمجرد الحصول على الرخصة والتخلّي عن العادات الجيدة (السرعة، الهاتف، مسافات الأمان). مخالفة خطيرة واحدة قد تُفقدك رخصتك الجديدة تماماً.",
      bva: "",
      methode: [
      ...
      quiz: [
        {
          ...
          explication:
            "خلال فترة الاختبار: 110 على الطريق السريع، 100 على الطرق السريعة، 80 على الطرق، خلال السنوات الثلاث الأولى.",
        },
        {
        ...
        },
        {
          ...
          explication:
            "6 نقاط في البداية: مخالفة خطيرة واحدة قد تُفقدك كل شيء.",
        },
        {
          q: "ما هو الحدّ الأقصى لنسبة الكحول في الدم للسائق الجديد؟",
          options: ["0,5 غ/ل مثل الآخرين", "0,2 غ/ل (عملياً، صفر)", "لا حدّ"],

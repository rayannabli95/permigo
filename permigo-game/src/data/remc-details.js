...
export const REMC_DETAILS = {
  ...
  C4a: {
    summary: 'Préparer et réaliser un trajet long en autonomie complète.',
    keyPoints: [
      'Itinéraire planifié, alternatives en tête',
      'Pause toutes les 2h + hydratation',
      'Connaître les zones difficiles à l\'avance',
    ],
    tip: 'Avant un long trajet : sommeil + repas léger + check véhicule. Pas de précipitation.',
  },
  C4b: {
    summary: 'Adopter une conduite éco-responsable : moins de carburant, moins de CO₂.',
    keyPoints: [
      'Anticiper pour éviter freinages inutiles',
      'Rapports élevés à basse vitesse',
      'Couper le moteur à l\'arrêt prolongé',
    ],
    tip: 'Conduire éco = 20% de carburant économisé + voiture qui dure plus longtemps.',
  },
  C4c: {
    summary: 'Connaître et appliquer les règles administratives du permis (papiers, contrôle technique, assurance).',
    keyPoints: [
      'Permis, carte grise, attestation assurance',
      'Contrôle technique tous les 2 ans',
      'Changement d\'adresse à signaler',
    ],
    tip: 'En contrôle : présente tes papiers calmement. Toujours à portée dans la boîte à gants.',
  },
  C4d: {
    summary: 'Comprendre les risques liés à ta santé, aux médicaments et à la fatigue.',
    keyPoints: [
      'Alcool : 0,5 g/L → permis suspendu',
      'Médicaments triangle = vigilance réduite',
      'Sommeil < 6h = réflexes diminués',
    ],
    tip: 'Pictogramme triangle rouge sur la boîte = ne conduis pas. Lis toujours la notice.',
  },
  C4e: {
    summary: 'Connaître les risques liés aux nouveaux usagers (jeunes, seniors, cyclistes, trottinettes).',
    keyPoints: [
      'Cyclistes : 1m en ville, 1,5m hors agglo',
      'Piétons en zone 30 : priorité absolue',
      'Trottinettes : trajectoires imprévisibles',
    ],
    tip: 'Plus l\'usager est petit, plus tu dois être prudent. Anticipe leurs erreurs.',
  },
  C4f: {
    summary: 'Connaître les bases de la mécanique pour réagir en cas de panne simple.',
    keyPoints: [
      'Pneu crevé : changer ou roue de secours',
      'Batterie à plat : pinces + autre véhicule',
      'Voyant moteur : t\'arrêter, vérifier',
    ],
    tip: 'Voyant rouge fixe = arrête-toi immédiatement. Voyant orange = vérifie dès que possible.',
  },
  C4g: {
    summary: 'Adopter les bonnes pratiques pour partager la route en sécurité et avec respect.',
    keyPoints: [
      'Courtoisie : laisser passer, remercier',
      'Pas d\'agressivité, pas de représailles',
      'Conduite défensive plutôt que sportive',
    ],
    tip: 'La route appartient à tout le monde. Un conducteur civil = moins d\'accidents.',
  },
};

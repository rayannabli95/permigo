...
const STYLE = `<style>
  .cf {
    min-height: 100dvh; font-family: 'Archivo', var(--fb), sans-serif;
  ...
  .cf h1 { font: 800 26px/1.2 'Archivo', sans-serif; color: #f4f1ff; margin: 0 0 8px; text-shadow: 0 3px 0 rgba(12,7,32,.8); }
  .cf-sub { font: 600 14px/1.55 'Archivo', sans-serif; color: #aaa2d8; margin: 0 0 22px; }
  .cf-opt {
    ...
    font: 700 14.5px/1.3 'Archivo', sans-serif; color: #cdc8ec;
  ...
  .cf textarea, .cf input[type="email"] {
    ...
    font: 600 15px/1.4 'Archivo', sans-serif; color: #f4f1ff;
  ...
  .cf-lbl { display: block; font: 700 12.5px/1 'Archivo', sans-serif; letter-spacing: .08em; text-transform: uppercase; color: #8b7fc4; margin: 18px 0 4px; }
  .cf-send {
  ...
  .cf-back { display: block; text-align: center; font: 700 13.5px 'Archivo', sans-serif; color: #aaa2d8; margin-top: 16px; }
  .cf-err { font: 700 13px/1.4 'Archivo', sans-serif; color: #ffb4a8; text-align: center; margin: 10px 0 0; display: none; }
  ...
  .cf-resil-t { font: 800 17px/1.2 'Archivo', sans-serif; color: #f4f1ff; margin: 0 0 6px; }
  .cf-resil-s { font: 600 13px/1.5 'Archivo', sans-serif; color: #aaa2d8; margin: 0 0 14px; }
  .cf-resil-btn {
    width: 100%; border: 1.5px solid rgba(255,255,255,.22); cursor: pointer; border-radius: 14px; padding: 14px;
    font: 800 15px/1 'Archivo', sans-serif; color: #f4f1ff; background: rgba(255,255,255,.06);
  ...
  .cf-resil-err { font: 700 13px/1.5 'Archivo', sans-serif; color: #ffce4d; text-align: center; margin: 12px 0 0; display: none; }

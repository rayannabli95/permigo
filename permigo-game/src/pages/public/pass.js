  ...
  fr: {
    ...
    feats: [
      ...
      },
      {
        ...
        // « Le jour J, zéro surprise » promet ce qu'aucune app ne peut tenir :
        // il suffit d'un examinateur pressé ou d'un giratoire inconnu pour
        // que ce soit faux. On garde ce qui est vrai et vérifiable : la grille
        // de l'examen est publique, et on note dessus.
        d: "Notée sur la grille officielle de l'examen. Tu sais où tu en es avant le jour J.",
      },
      {
        img: "/skins/volant-coin.webp",
        // « Et ça donne envie de revenir » dit notre objectif à nous, pas le
        // sien. L'élève se fiche de revenir, il veut progresser.
        t: "Progresser devient un jeu",
  ...
  en: {
    ...
    feats: [
      ...
      },
      {
        ...
        d: "Scored on the official exam grid. You know where you stand before test day.",
      },
      {
        img: "/skins/volant-coin.webp",
        t: "Progress becomes a game",
  ...
  ar: {
    ...
    feats: [
      ...
      },
      {
        ...
        d: "تُقيَّم وفق شبكة الامتحان الرسمية. تعرف أين وصلت قبل يوم الامتحان.",
      },
      {
        img: "/skins/volant-coin.webp",
        t: "التقدّم يصبح لعبة",

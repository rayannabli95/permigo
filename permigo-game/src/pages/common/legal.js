  ...
  cgu: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Les abonnements PermiGo (abonnement mensuel élève à 4,99 €/mois et abonnement moniteur à 9,99 €/mois) sont sans engagement et se renouvellent automatiquement chaque mois. Vous pouvez les résilier en ligne à tout moment, en quelques clics, depuis Réglages → Gérer mon abonnement (portail de gestion sécurisé). La résiliation prend effet à la fin de la période déjà payée : aucun nouveau prélèvement n'a lieu ensuite, et l'accès reste ouvert jusqu'à cette échéance. Garantie « satisfait ou remboursé » : tout achat est intégralement remboursable sur simple demande dans les 3 jours suivant son règlement, à contact@permigo.fr. Droit de rétractation : conformément aux articles L221-18 et suivants du Code de la consommation, vous disposez d'un délai de rétractation de 14 jours. S'agissant d'un contenu numérique fourni immédiatement, vous demandez expressément l'accès dès le paiement et reconnaissez renoncer à votre droit de rétractation pour la partie du contenu déjà exécutée ; notre garantie de remboursement 3 jours ci-dessus reste, elle, acquise.",
      },
      {
    ...
    cgu: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "PermiGo subscriptions (monthly student subscription at €4.99/month and instructor subscription at €9.99/month) have no minimum term and renew automatically each month. You may cancel them online at any time, in just a few clicks, from Settings → Manage my subscription (secure management portal). Cancellation takes effect at the end of the period already paid for: no further payment is taken and access remains open until that date. “Satisfied or refunded” guarantee: any purchase is fully refundable on request within 3 days of payment by contacting contact@permigo.fr. Right of withdrawal: in accordance with Articles L221-18 et seq. of the French Consumer Code, you have a 14-day withdrawal period. As digital content is supplied immediately, you expressly request access from the time of payment and acknowledge that you waive your right of withdrawal for the part of the content already supplied; our 3-day refund guarantee above remains unaffected.",
        },
        {
    ...
    cgu: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "اشتراكات بيرميغو (الاشتراك الشهري للطالب بسعر 4.99 يورو شهريًا واشتراك المدرّب بسعر 9.99 يورو شهريًا) بلا التزام زمني وتتجدد تلقائيًا كل شهر. يمكنك إلغاؤها عبر الإنترنت في أي وقت ببضع نقرات من الإعدادات ← إدارة اشتراكي (بوابة إدارة آمنة). يسري الإلغاء في نهاية الفترة المدفوعة: لا يتم أي خصم جديد، ويبقى الوصول متاحًا حتى ذلك التاريخ. ضمان «الرضا أو استرداد المال»: يمكن استرداد قيمة أي عملية شراء كاملة بطلب بسيط خلال 3 أيام من الدفع عبر contact@permigo.fr. حق العدول: وفقًا للمواد L221-18 وما يليها من قانون المستهلك الفرنسي، لديك مهلة عدول مدتها 14 يومًا. وبما أن المحتوى الرقمي يُقدّم فورًا، فإنك تطلب صراحة الوصول إليه من لحظة الدفع وتقر بالتنازل عن حق العدول بالنسبة إلى الجزء المنفذ من المحتوى؛ ويبقى ضمان الاسترداد خلال 3 أيام المذكور أعلاه ساريًا.",
        },
        {

...
/* Le cadre suit un ratio, PAS une hauteur fixe : la capture fait 780×980 (le
   ...
   coupe empirait à mesure que l'écran s'élargissait. Ratio 780/475 + cover
   avec un object-position calé sur la scène iso (y ≈ 85→462 dans la source) :
   le carrefour tient EN ENTIER, au même cadrage sur tous les écrans. */

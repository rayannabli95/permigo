...
//   - Ma collection → RETIRÉE le 07/08/2026 : elle redisait le profil (les
//     3 fonds de permis s'y voient déjà, et ils ne s'équipent pas à la main).
...
// Noms des objets boutique : data/rewards-i18n.js (mêmes textes que la
// boutique). En 'fr' ou clé absente → FR inchangé.
const REC_I18N = {
  en: {
    title: "Rewards",

...
function template() {
  return `
    <style>
      .np-root{position:fixed;inset:0;overflow:auto;overscroll-behavior:contain;--ink:#f4f1ff;background:#0b0d1a;display:flex;align-items:center;justify-content:center;padding:calc(24px + env(safe-area-inset-top,0px)) calc(16px + env(safe-area-inset-right,0px)) calc(24px + env(safe-area-inset-bottom,0px)) calc(16px + env(safe-area-inset-left,0px));font-family:var(--fb);z-index:50}

  ...
  try {
    ...
    app.innerHTML = `
      <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100dvh;gap:14px;padding:32px;text-align:center;background:var(--bg);color:var(--ink)">
        ...
        <div style="font:800 17px/1.3 'Archivo',sans-serif;color:var(--ink);letter-spacing:-.02em">Quelque chose a planté</div>
        <div style="font:500 13px/1.5 'Archivo',sans-serif;color:var(--mu)">Une erreur inattendue est survenue.<br>Recharge la page pour réessayer.</div>
        <button onclick="location.reload()" style="margin-top:6px;padding:13px 28px;min-height:44px;background:var(--a);color:var(--a-ink);border:none;border-radius:12px;font:700 14px 'Archivo',sans-serif;cursor:pointer;letter-spacing:-.01em">
          Recharger l'app
        </button>
      </div>
    `;

...
.prf-row-lbl { font: 500 11px/1 'IBM Plex Mono', monospace; color: #64748b; margin-bottom: 3px; }
.prf-row-val { font: 600 14px/1.3 'Inter', sans-serif; color: #fff; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
.prf-btn-logout:hover { background: rgba(239,68,68,.18); }
...
.prf-streak-n {
  font: 800 20px/1 'IBM Plex Mono', monospace;
  color: #fbbf24;
}
.prf-streak-lbl {
  ...
  <div class="prf-section">
    ...
    <div class="prf-row">
      ...
      <div class="prf-row-body">
        ...
        <div class="prf-row-val" style="font-family:'IBM Plex Mono',monospace;color:#a5b4fc">${esc(String(profile.xp))} XP</div>
      </div>
    </div>` : ''}
    <div class="prf-row">
      <span class="prf-row-ico">🔑</span>
      <div class="prf-row-body">
        ...
        <div class="prf-row-val" style="font-family:'IBM Plex Mono',monospace;font-size:11px;color:#64748b">${esc(me.id)}</div>
      </div>
    </div>
  </div>

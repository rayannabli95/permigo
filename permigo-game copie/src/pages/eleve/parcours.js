...
.prc-subtitle { font: 500 11px/1 'IBM Plex Mono', monospace; color: #94a3b8; margin-top: 3px; }
...
.prc-total-lbl{ font: 600 10px/1 'IBM Plex Mono', monospace; color: #94a3b8; margin-top: 3px; }
...
.prc-final-stat .l { font: 600 9px/1 'IBM Plex Mono', monospace; color: #94a3b8; text-transform: uppercase; letter-spacing: 1px; margin-top: 3px; }
...
.fiche-meta-row .mv { color: #0a0d1a; font-weight: 700; font-family: 'IBM Plex Mono', monospace; font-size: 12px; }
.fiche-empty {
  text-align: center;
  padding: 18px;
}
